...
export function RootLayout() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-canvas text-ink">
      <SiteHeader />
      <motion.main
        className="mx-auto w-full max-w-[1280px] flex-1 px-4 py-10 sm:px-8 sm:py-12"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      {!isAppRoute && (
        ...
        <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-1 px-4 py-8 sm:flex-row sm:items-center sm:justify-between sm:px-8">
